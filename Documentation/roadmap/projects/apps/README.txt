README.txt: Minisip Application WG Overview
===========================================
...
The Application Working Group seeks to develop and maintain those portions
of the software deliverables which directly interface with the user.  This
presently includes the 'minisip' package itself.

============
Applications
------------

The 'minisip' project contains the following applications that are supported
