...
#ifndef DIRECTSOUNDDRIVER_H
#define DIRECTSOUNDDRIVER_H
...
class DirectSoundDriver: public SoundDriver{
	public:
		DirectSoundDriver( MRef<Library*> lib );
		virtual ~DirectSoundDriver();
		virtual MRef<SoundDevice*> createDevice( std::string deviceId );
		virtual std::string getDescription() const { return "DirectSound sound driver"; };
