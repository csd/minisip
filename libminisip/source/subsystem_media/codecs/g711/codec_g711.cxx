...
g711_init()
{
        ...
        for(i = -32767; i < 32768; i++) 
                lintomulaw[(unsigned short)i] = linear2ulaw((short)i);

        for(i = 0; i < 256; i++) 
                alawtolin[i] = alaw2linear((unsigned char)i);

        for(i = -32767; i < 32768; i+= 8) 
                lintoalaw[(unsigned short)i>>3] = linear2alaw((short)i);
...
//{
//        return (unsigned short) G711_NUM_FORMATS;
//}

//const codec_format_t*
//g711_get_format(unsigned short idx)
//{
...
//int
//g711_encode (unsigned short idx, u_char *state, short *in, coded_unit *out)
//{
//        int len;
//        u_char *p, *pe;
//
...
//int
//g711_decode(unsigned short idx, u_char *state, coded_unit *in, short *out)
//{
//        int len;
//        u_char *p, *pe;
//
