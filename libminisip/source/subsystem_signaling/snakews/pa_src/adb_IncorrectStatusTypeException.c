        ...
        /**
         * adb_IncorrectStatusTypeException.c
         *
        ...
        #include "adb_IncorrectStatusTypeException.h"
                 ...
                 * name = IncorrectStatusTypeException
        ...
        struct adb_IncorrectStatusTypeException
        {
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_IncorrectStatusTypeException_set_message_nil(
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_IncorrectStatusTypeException_create(
            const axutil_env_t *env)
        {
            adb_IncorrectStatusTypeException_t *_IncorrectStatusTypeException = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _IncorrectStatusTypeException = (adb_IncorrectStatusTypeException_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_IncorrectStatusTypeException_t));

            if(NULL == _IncorrectStatusTypeException)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_IncorrectStatusTypeException, 0, sizeof(adb_IncorrectStatusTypeException_t));

            _IncorrectStatusTypeException->property_message  = NULL;
                  _IncorrectStatusTypeException->is_valid_message  = AXIS2_FALSE;
            

            return _IncorrectStatusTypeException;
        }
                ...
                const axutil_env_t *env)
        {
            ...
            adb_IncorrectStatusTypeException_reset_message(_IncorrectStatusTypeException, env);
            

            if(_IncorrectStatusTypeException)
            {
                AXIS2_FREE(env->allocator, _IncorrectStatusTypeException);
                _IncorrectStatusTypeException = NULL;
            }
         ...
         int tag_closed = 0;
            ...
            adb_IncorrectStatusTypeException_get_message(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _IncorrectStatusTypeException->property_message;
             }
            ...
            adb_IncorrectStatusTypeException_set_message(
                    ...
                    const axis2_char_t*  arg_message)
             {
                ...
                if(_IncorrectStatusTypeException->is_valid_message &&
                        arg_message == _IncorrectStatusTypeException->property_message)
                {
                ...
                _IncorrectStatusTypeException->property_message = (axis2_char_t *)axutil_strdup(env, arg_message);
                        if(NULL == _IncorrectStatusTypeException->property_message)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for message");
                            return AXIS2_FAILURE;
                        }
                        _IncorrectStatusTypeException->is_valid_message = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _IncorrectStatusTypeException, AXIS2_FAILURE);
                ...
                if(_IncorrectStatusTypeException->property_message != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _IncorrectStatusTypeException->property_message);
                     _IncorrectStatusTypeException->property_message = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _IncorrectStatusTypeException, AXIS2_TRUE);
               
               return !_IncorrectStatusTypeException->is_valid_message;
           }
           ...
           adb_IncorrectStatusTypeException_set_message_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_IncorrectStatusTypeException_reset_message(_IncorrectStatusTypeException, env);
           }
