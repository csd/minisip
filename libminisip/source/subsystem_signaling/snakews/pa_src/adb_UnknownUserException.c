        ...
        struct adb_UnknownUserException
        {
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_UnknownUserException_set_message_nil(
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_UnknownUserException_create(
            const axutil_env_t *env)
        {
            adb_UnknownUserException_t *_UnknownUserException = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _UnknownUserException = (adb_UnknownUserException_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_UnknownUserException_t));

            if(NULL == _UnknownUserException)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_UnknownUserException, 0, sizeof(adb_UnknownUserException_t));

            _UnknownUserException->property_message  = NULL;
                  _UnknownUserException->is_valid_message  = AXIS2_FALSE;
            

            return _UnknownUserException;
        }
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _UnknownUserException, AXIS2_FAILURE);

            adb_UnknownUserException_reset_message(_UnknownUserException, env);
            

            if(_UnknownUserException)
            {
                AXIS2_FREE(env->allocator, _UnknownUserException);
                _UnknownUserException = NULL;
            }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname) || !axutil_strcmp("message", axiom_element_get_localname(current_element, env)))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname) || !axutil_strcmp("message", axiom_element_get_localname(current_element, env))))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      if(text_value != NULL)
                                      {
                                            status = adb_UnknownUserException_set_message(_UnknownUserException, env,
                                                               text_value);
                                      }
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _UnknownUserException, NULL);
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   if (!_UnknownUserException->is_valid_message)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = _UnknownUserException->property_message;
            ...
            adb_UnknownUserException_get_message(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _UnknownUserException->property_message;
             }
            ...
            adb_UnknownUserException_set_message(
                    ...
                    const axis2_char_t*  arg_message)
             {
                ...
                if(_UnknownUserException->is_valid_message &&
                        arg_message == _UnknownUserException->property_message)
                {
                ...
                _UnknownUserException->property_message = (axis2_char_t *)axutil_strdup(env, arg_message);
                        if(NULL == _UnknownUserException->property_message)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for message");
                            return AXIS2_FAILURE;
                        }
                        _UnknownUserException->is_valid_message = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _UnknownUserException, AXIS2_FAILURE);
                ...
                if(_UnknownUserException->property_message != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _UnknownUserException->property_message);
                     _UnknownUserException->property_message = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _UnknownUserException, AXIS2_TRUE);
               
               return !_UnknownUserException->is_valid_message;
           }
           ...
           adb_UnknownUserException_set_message_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_UnknownUserException_reset_message(_UnknownUserException, env);
           }
