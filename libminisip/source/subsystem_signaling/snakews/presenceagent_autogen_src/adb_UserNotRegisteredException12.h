        ...
        #ifndef ADB_USERNOTREGISTEREDEXCEPTION12_H
        #define ADB_USERNOTREGISTEREDEXCEPTION12_H

       /**
        * adb_UserNotRegisteredException12.h
        *
       ...
       /**
        *  adb_UserNotRegisteredException12 class
        */
        typedef struct adb_UserNotRegisteredException12 adb_UserNotRegisteredException12_t;
        ...
        /**
         * Constructor for creating adb_UserNotRegisteredException12_t
         * @param env pointer to environment struct
         * @return newly created adb_UserNotRegisteredException12_t object
         */
        ...
        /**
         * Free adb_UserNotRegisteredException12_t object
         * @param  _UserNotRegisteredException12 adb_UserNotRegisteredException12_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _UserNotRegisteredException12 adb_UserNotRegisteredException12_t object
         * @param env pointer to environment struct
       ...
       adb_UserNotRegisteredException12_declare_parent_namespaces(
         ...
         * @param  _UserNotRegisteredException12 adb_UserNotRegisteredException12_t object
         * @param env pointer to environment struct
         * @param UserNotRegisteredException12_om_node node to serialize from
         * @param UserNotRegisteredException12_om_element parent element to serialize from
        ...
        adb_UserNotRegisteredException12_serialize(
            adb_UserNotRegisteredException12_t* _UserNotRegisteredException12,
            const axutil_env_t *env,
            axiom_node_t* UserNotRegisteredException12_om_node, axiom_element_t *UserNotRegisteredException12_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the adb_UserNotRegisteredException12 is a particle class (E.g. group, inner sequence)
     ...
     #endif /* ADB_USERNOTREGISTEREDEXCEPTION12_H */
