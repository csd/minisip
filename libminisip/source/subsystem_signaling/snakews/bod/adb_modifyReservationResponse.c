        ...
        /**
         * adb_modifyReservationResponse.c
         *
        ...
        struct adb_modifyReservationResponse
        {
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_modifyReservationResponse_set_ReservationStatus_nil(
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_modifyReservationResponse_create(
            const axutil_env_t *env)
        {
            adb_modifyReservationResponse_t *_modifyReservationResponse = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _modifyReservationResponse = (adb_modifyReservationResponse_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_modifyReservationResponse_t));

            if(NULL == _modifyReservationResponse)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_modifyReservationResponse, 0, sizeof(adb_modifyReservationResponse_t));

            _modifyReservationResponse->property_ReservationStatus  = NULL;
                  _modifyReservationResponse->is_valid_ReservationStatus  = AXIS2_FALSE;
            

            return _modifyReservationResponse;
        }
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _modifyReservationResponse, AXIS2_FAILURE);

            adb_modifyReservationResponse_reset_ReservationStatus(_modifyReservationResponse, env);
            

            if(_modifyReservationResponse)
            {
                AXIS2_FREE(env->allocator, _modifyReservationResponse);
                _modifyReservationResponse = NULL;
            }
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname) || !axutil_strcmp("ReservationStatus", axiom_element_get_localname(current_element, env)))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname) || !axutil_strcmp("ReservationStatus", axiom_element_get_localname(current_element, env))))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_modifyReservationResponse_set_ReservationStatus(_modifyReservationResponse, env,
                ...
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _modifyReservationResponse, NULL);
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   if (!_modifyReservationResponse->is_valid_ReservationStatus)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_ReservationStatus_serialize(_modifyReservationResponse->property_ReservationStatus, 
            ...
            adb_modifyReservationResponse_get_ReservationStatus(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _modifyReservationResponse->property_ReservationStatus;
             }
            ...
            adb_modifyReservationResponse_set_ReservationStatus(
                    ...
                    adb_ReservationStatus_t*  arg_ReservationStatus)
             {
                ...
                if(_modifyReservationResponse->is_valid_ReservationStatus &&
                        arg_ReservationStatus == _modifyReservationResponse->property_ReservationStatus)
                {
                ...
                _modifyReservationResponse->property_ReservationStatus = arg_ReservationStatus;
                        _modifyReservationResponse->is_valid_ReservationStatus = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _modifyReservationResponse, AXIS2_FAILURE);
                ...
                if(_modifyReservationResponse->property_ReservationStatus != NULL)
                {
                   
                   
                        adb_ReservationStatus_free(_modifyReservationResponse->property_ReservationStatus, env);
                     _modifyReservationResponse->property_ReservationStatus = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _modifyReservationResponse, AXIS2_TRUE);
               
               return !_modifyReservationResponse->is_valid_ReservationStatus;
           }
           ...
           adb_modifyReservationResponse_set_ReservationStatus_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_modifyReservationResponse_reset_ReservationStatus(_modifyReservationResponse, env);
           }
