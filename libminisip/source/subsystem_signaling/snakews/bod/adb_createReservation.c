       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_createReservation_set_sessionId_nil(
                        adb_createReservation_t* _createReservation,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_createReservation_set_bandwidthRequest_nil(
                        adb_createReservation_t* _createReservation,
                        const axutil_env_t *env);
            

                axis2_status_t AXIS2_CALL
                adb_createReservation_set_bidirectional_nil(
                        adb_createReservation_t* _createReservation,
                        const axutil_env_t *env);
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_createReservation_create(
            const axutil_env_t *env)
        {
            adb_createReservation_t *_createReservation = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _createReservation = (adb_createReservation_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_createReservation_t));

            if(NULL == _createReservation)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_createReservation, 0, sizeof(adb_createReservation_t));

            _createReservation->property_sessionId  = NULL;
                  _createReservation->is_valid_sessionId  = AXIS2_FALSE;
            _createReservation->property_bandwidthRequest  = NULL;
                  _createReservation->is_valid_bandwidthRequest  = AXIS2_FALSE;
            _createReservation->is_valid_bidirectional  = AXIS2_FALSE;
            

            return _createReservation;
        }

        axis2_status_t AXIS2_CALL
        adb_createReservation_free (
                adb_createReservation_t* _createReservation,
                const axutil_env_t *env)
        {
            ...
            adb_createReservation_reset_sessionId(_createReservation, env);
            adb_createReservation_reset_bandwidthRequest(_createReservation, env);
            adb_createReservation_reset_bidirectional(_createReservation, env);
            

            if(_createReservation)
            {
                AXIS2_FREE(env->allocator, _createReservation);
                _createReservation = NULL;
            }
                ...
                axis2_bool_t dont_care_minoccurs)
        {
          ...
          adb_createReservation_is_particle()
          {
          ...
          void AXIS2_CALL
          adb_createReservation_declare_parent_namespaces(
                    adb_createReservation_t* _createReservation,
        ...
        adb_createReservation_serialize(
                adb_createReservation_t* _createReservation,
                const axutil_env_t *env, axiom_node_t *parent, axiom_element_t *parent_element, int parent_tag_closed, axutil_hash_t *namespaces, int *next_ns_index)
        {
         ...
         int tag_closed = 0;
            ...
            AXIS2_ENV_CHECK(env, NULL);
            AXIS2_PARAM_CHECK(env->error, _createReservation, NULL);
            ...
            if(!parent_tag_closed)
            {
              ...
              tag_closed = 1;
                   ...
                   if (!_createReservation->is_valid_sessionId)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_1 = _createReservation->property_sessionId;
                   ...
                   if (!_createReservation->is_valid_bandwidthRequest)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                            ...
                            adb_bandwidthRequest_serialize(_createReservation->property_bandwidthRequest, 
                   ...
                   if (!_createReservation->is_valid_bidirectional)
                   {
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           strcpy(text_value_3, (_createReservation->property_bidirectional)?"true":"false");
            ...
            adb_createReservation_get_sessionId(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env)
             {
                ...
                return _createReservation->property_sessionId;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_createReservation_set_sessionId(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env,
                    const axis2_char_t*  arg_sessionId)
             {
                ...
                if(_createReservation->is_valid_sessionId &&
                        arg_sessionId == _createReservation->property_sessionId)
                {
                ...
                _createReservation->property_sessionId = (axis2_char_t *)axutil_strdup(env, arg_sessionId);
                        if(NULL == _createReservation->property_sessionId)
                        {
                            AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, "Error allocating memeory for sessionId");
                            return AXIS2_FAILURE;
                        }
                        _createReservation->is_valid_sessionId = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_createReservation_reset_sessionId(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _createReservation, AXIS2_FAILURE);
                ...
                if(_createReservation->property_sessionId != NULL)
                {
                   
                   
                        AXIS2_FREE(env-> allocator, _createReservation->property_sessionId);
                     _createReservation->property_sessionId = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_createReservation_is_sessionId_nil(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               AXIS2_PARAM_CHECK(env->error, _createReservation, AXIS2_TRUE);
               
               return !_createReservation->is_valid_sessionId;
           }
           ...
           adb_createReservation_set_sessionId_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_createReservation_reset_sessionId(_createReservation, env);
           }
            ...
            adb_createReservation_get_bandwidthRequest(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env)
             {
                ...
                return _createReservation->property_bandwidthRequest;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_createReservation_set_bandwidthRequest(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env,
                    adb_bandwidthRequest_t*  arg_bandwidthRequest)
             {
                ...
                if(_createReservation->is_valid_bandwidthRequest &&
                        arg_bandwidthRequest == _createReservation->property_bandwidthRequest)
                {
                ...
                _createReservation->property_bandwidthRequest = arg_bandwidthRequest;
                        _createReservation->is_valid_bandwidthRequest = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_createReservation_reset_bandwidthRequest(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               int i = 0;
               ...
               AXIS2_PARAM_CHECK(env->error, _createReservation, AXIS2_FAILURE);
                ...
                if(_createReservation->property_bandwidthRequest != NULL)
                {
                   
                   
                        adb_bandwidthRequest_free(_createReservation->property_bandwidthRequest, env);
                     _createReservation->property_bandwidthRequest = NULL;
                }
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_createReservation_is_bandwidthRequest_nil(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_createReservation->is_valid_bandwidthRequest;
           }
           ...
           adb_createReservation_set_bandwidthRequest_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_createReservation_reset_bandwidthRequest(_createReservation, env);
           }
             ...
             */
            axis2_bool_t AXIS2_CALL
            adb_createReservation_get_bidirectional(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env)
             {
                
                    AXIS2_ENV_CHECK(env, (axis2_bool_t)0);
                    AXIS2_PARAM_CHECK(env->error, _createReservation, (axis2_bool_t)0);
                  

                return _createReservation->property_bidirectional;
             }
             ...
             */
            axis2_status_t AXIS2_CALL
            adb_createReservation_set_bidirectional(
                    adb_createReservation_t* _createReservation,
                    const axutil_env_t *env,
                    axis2_bool_t  arg_bidirectional)
             {
                ...
                if(_createReservation->is_valid_bidirectional &&
                        arg_bidirectional == _createReservation->property_bidirectional)
                {
                ...
                _createReservation->property_bidirectional = arg_bidirectional;
                        _createReservation->is_valid_bidirectional = AXIS2_TRUE;
            ...
            */
           axis2_status_t AXIS2_CALL
           adb_createReservation_reset_bidirectional(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               int i = 0;
            ...
            */
           axis2_bool_t AXIS2_CALL
           adb_createReservation_is_bidirectional_nil(
                   adb_createReservation_t* _createReservation,
                   const axutil_env_t *env)
           {
               AXIS2_ENV_CHECK(env, AXIS2_TRUE);
               ...
               return !_createReservation->is_valid_bidirectional;
           }
           ...
           adb_createReservation_set_bidirectional_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_createReservation_reset_bidirectional(_createReservation, env);
           }
