      ...
      /**
       * axis2_stub_BoDServiceStubService.c
       *
      ...
      #include "axis2_stub_BoDServiceStubService.h"
      #include <axis2_msg.h>

      /**
       * axis2_stub_BoDServiceStubService C implementation
       */
                                      ...
                                      axis2_char_t *endpoint_uri)
      {
         ...
         {
            endpoint_uri = axis2_stub_get_endpoint_uri_of_BoDServiceStubService(env);
         }
         ...
         axis2_stub_populate_services_for_BoDServiceStubService(stub, env);
         return stub;
      }


      void
      axis2_stub_populate_services_for_BoDServiceStubService(axis2_stub_t *stub, const axutil_env_t *env)
      {
         ...
         svc_qname = axutil_qname_create(env,"BoDServiceStubService" ,NULL, NULL);
      ...
      axis2_stub_get_endpoint_uri_of_BoDServiceStubService( const axutil_env_t *env )
      {
        ...
        /* set the address from here */
              ...
              endpoint_uri = "http://esb.hdviper.org:8080/hdviper-bod-us/BoDServiceStub";
        ...
        return endpoint_uri;
                                              ...
                                              adb_reservationStatusChanged1_t* _reservationStatusChanged)
         {
            ...
            adb_reservationStatusChangedResponse2_t* ret_val = NULL;
            
                       payload = adb_reservationStatusChanged1_serialize(_reservationStatusChanged, env, NULL, NULL, AXIS2_TRUE, NULL, NULL);
            ...
            if (!is_soap_act_set)
            {
              ...
              axis2_options_set_action( options, env, NULL);
                    ...
                    ret_val = adb_reservationStatusChangedResponse2_create(env);

                    if(adb_reservationStatusChangedResponse2_deserialize(ret_val, env, &ret_node, NULL, AXIS2_FALSE ) == AXIS2_FAILURE)
                    {
                        if(ret_val != NULL)
                        {
                            adb_reservationStatusChangedResponse2_free(ret_val, env);
                        }

                        AXIS2_LOG_ERROR( env->log, AXIS2_LOG_SI, "NULL returnted from the reservationStatusChangedResponse2_deserialize: "
        ...
        struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data
        {   
            void *data;
        ...
        static axis2_status_t AXIS2_CALL axis2_stub_on_error_BoDServiceStubService_reservationStatusChanged(axis2_callback_t *callback, const axutil_env_t *env, int exception)
        {
            axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int, void *data);
            struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data* callback_data = NULL;
            void *user_data = NULL;

            axis2_status_t status;
        
            callback_data = (struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data*)axis2_callback_get_data(callback);
        ...
        axis2_status_t AXIS2_CALL axis2_stub_on_complete_BoDServiceStubService_reservationStatusChanged(axis2_callback_t *callback, const axutil_env_t *env)
        {
            axis2_status_t ( AXIS2_CALL *on_complete ) (const axutil_env_t *, adb_reservationStatusChangedResponse2_t* _reservationStatusChangedResponse, void *data);
            struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data* callback_data = NULL;
            void *user_data = NULL;
        ...
        /**
                                                  ...
                                                  axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int exception, void *data) )
         {
            ...
            struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data *callback_data;

            callback_data = (struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data*) AXIS2_MALLOC(env->allocator, 
                                    sizeof(struct axis2_stub_BoDServiceStubService_reservationStatusChanged_callback_data));
            ...
            axis2_callback_set_on_complete(callback, axis2_stub_on_complete_BoDServiceStubService_reservationStatusChanged);
            /* Set our on_error function pointer to the callback object */
            axis2_callback_set_on_error(callback, axis2_stub_on_error_BoDServiceStubService_reservationStatusChanged);
