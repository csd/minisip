        ...
        #ifndef ADB_RESERVATIONSTATE_H
        #define ADB_RESERVATIONSTATE_H

       /**
        * adb_reservationState.h
        *
       ...
       /**
        *  adb_reservationState class
        */
        typedef struct adb_reservationState adb_reservationState_t;
        ...
        /**
         * Constructor for creating adb_reservationState_t
         * @param env pointer to environment struct
         * @return newly created adb_reservationState_t object
         */
        ...
        /**
         * Free adb_reservationState_t object
         * @param  _reservationState adb_reservationState_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for code. 
         * @param  _reservationState adb_reservationState_t object
         * @param env pointer to environment struct
         * @return int
         */
        int AXIS2_CALL
       ...
       adb_reservationState_declare_parent_namespaces(
         ...
         * @param  _reservationState adb_reservationState_t object
         * @param env pointer to environment struct
         * @param reservationState_om_node node to serialize from
         * @param reservationState_om_element parent element to serialize from
        ...
        adb_reservationState_serialize(
            adb_reservationState_t* _reservationState,
            const axutil_env_t *env,
            axiom_node_t* reservationState_om_node, axiom_element_t *reservationState_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the adb_reservationState is a particle class (E.g. group, inner sequence)
