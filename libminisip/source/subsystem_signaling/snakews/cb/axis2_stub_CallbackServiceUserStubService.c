      ...
      /**
       * axis2_stub_CallbackServiceUserStubService.c
       *
      ...
      #include "axis2_stub_CallbackServiceUserStubService.h"
      #include <axis2_msg.h>

      /**
       * axis2_stub_CallbackServiceUserStubService C implementation
       */
      ...
      axis2_stub_get_endpoint_uri_of_CallbackServiceUserStubService( const axutil_env_t *env )
      {
        ...
        /* set the address from here */
              ...
              endpoint_uri = "http://esb.hdviper.org:8080/hdviper-callbackservice-us/CallbackServiceUserStub";
        ...
        struct axis2_stub_CallbackServiceUserStubService_getEvents_callback_data
        {   
            void *data;
        ...
        static axis2_status_t AXIS2_CALL axis2_stub_on_error_CallbackServiceUserStubService_getEvents(axis2_callback_t *callback, const axutil_env_t *env, int exception)
        {
            axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int, void *data);
            struct axis2_stub_CallbackServiceUserStubService_getEvents_callback_data* callback_data = NULL;
            void *user_data = NULL;

            axis2_status_t status;
        
            callback_data = (struct axis2_stub_CallbackServiceUserStubService_getEvents_callback_data*)axis2_callback_get_data(callback);
        ...
        axis2_status_t AXIS2_CALL axis2_stub_on_complete_CallbackServiceUserStubService_getEvents(axis2_callback_t *callback, const axutil_env_t *env)
        {
            axis2_status_t ( AXIS2_CALL *on_complete ) (const axutil_env_t *, adb_getEventsResponse0_t* _getEventsResponse, void *data);
            struct axis2_stub_CallbackServiceUserStubService_getEvents_callback_data* callback_data = NULL;
            void *user_data = NULL;
