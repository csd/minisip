        ...
        /**
         * adb_UserNotRegisteredException1.c
         *
         * This file was auto-generated from WSDL
         * by the Apache Axis2/C version: SNAPSHOT  Built on : Mar 10, 2008 (08:35:52 GMT+00:00)
         */

        #include "adb_UserNotRegisteredException1.h"
        
               /*
                * implmentation of the UserNotRegisteredException|http://esb.callbackservice.services.hdviper.psnc.pl/ element
                */
           


        struct adb_UserNotRegisteredException1
        {
       ...
       /************************* Private Function prototypes ********************************/
                ...
                adb_UserNotRegisteredException1_set_UserNotRegisteredException_nil(
       ...
       /************************* Function Implmentations ********************************/
        ...
        adb_UserNotRegisteredException1_create(
            const axutil_env_t *env)
        {
            adb_UserNotRegisteredException1_t *_UserNotRegisteredException1 = NULL;
            
                axutil_qname_t* qname = NULL;
            
            AXIS2_ENV_CHECK(env, NULL);

            _UserNotRegisteredException1 = (adb_UserNotRegisteredException1_t *) AXIS2_MALLOC(env->
                allocator, sizeof(adb_UserNotRegisteredException1_t));

            if(NULL == _UserNotRegisteredException1)
            {
                AXIS2_ERROR_SET(env->error, AXIS2_ERROR_NO_MEMORY, AXIS2_FAILURE);
                return NULL;
            }

            memset(_UserNotRegisteredException1, 0, sizeof(adb_UserNotRegisteredException1_t));

            _UserNotRegisteredException1->property_UserNotRegisteredException  = NULL;
                  _UserNotRegisteredException1->is_valid_UserNotRegisteredException  = AXIS2_FALSE;
            
                  qname =  axutil_qname_create (env,
                        "UserNotRegisteredException",
                        "http://esb.callbackservice.services.hdviper.psnc.pl/",
                        NULL);
                _UserNotRegisteredException1->qname = qname;
            

            return _UserNotRegisteredException1;
        }
                ...
                const axutil_env_t *env)
        {
            ...
            AXIS2_PARAM_CHECK(env->error, _UserNotRegisteredException1, AXIS2_FAILURE);

            adb_UserNotRegisteredException1_reset_UserNotRegisteredException(_UserNotRegisteredException1, env);
            
              if(_UserNotRegisteredException1->qname)
              {
                  axutil_qname_free (_UserNotRegisteredException1->qname, env);
                  _UserNotRegisteredException1->qname = NULL;
              }
            

            if(_UserNotRegisteredException1)
            {
                AXIS2_FREE(env->allocator, _UserNotRegisteredException1);
                _UserNotRegisteredException1 = NULL;
            }
            ...
            AXIS2_PARAM_CHECK(env->error, _UserNotRegisteredException1, AXIS2_FAILURE);
              ...
              if (NULL == parent)
              {
                ...
                return AXIS2_FAILURE;
                    ...
                    if (axutil_qname_equals(qname, env, _UserNotRegisteredException1-> qname))
                    {
                    ...
                    else
                    {
                        AXIS2_LOG_ERROR(env->log, AXIS2_LOG_SI, 
                              ...
                              axutil_qname_to_string(_UserNotRegisteredException1-> qname, env),
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(env, "UserNotRegisteredException", "http://esb.callbackservice.services.hdviper.psnc.pl/", NULL);
                                ...
                                (current_node   && current_element && (axutil_qname_equals(element_qname, env, qname))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, env, qname)))
                              {
                                is_early_node_valid = AXIS2_TRUE;
                                      ...
                                      {
                                          status = adb_UserNotRegisteredException1_set_UserNotRegisteredException(_UserNotRegisteredException1, env,
         ...
         int tag_closed = 0;
            ...
            adb_UserNotRegisteredException1_get_UserNotRegisteredException(
                    ...
                    const axutil_env_t *env)
             {
                ...
                return _UserNotRegisteredException1->property_UserNotRegisteredException;
             }
            ...
            adb_UserNotRegisteredException1_set_UserNotRegisteredException(
                    ...
                    adb_UserNotRegisteredException_t*  arg_UserNotRegisteredException)
             {
                ...
                if(_UserNotRegisteredException1->is_valid_UserNotRegisteredException &&
                        arg_UserNotRegisteredException == _UserNotRegisteredException1->property_UserNotRegisteredException)
                {
                ...
                _UserNotRegisteredException1->property_UserNotRegisteredException = arg_UserNotRegisteredException;
                        _UserNotRegisteredException1->is_valid_UserNotRegisteredException = AXIS2_TRUE;
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _UserNotRegisteredException1, AXIS2_FAILURE);
                ...
                if(_UserNotRegisteredException1->property_UserNotRegisteredException != NULL)
                {
                   
                   
                        adb_UserNotRegisteredException_free(_UserNotRegisteredException1->property_UserNotRegisteredException, env);
                     _UserNotRegisteredException1->property_UserNotRegisteredException = NULL;
                }
                   ...
                   const axutil_env_t *env)
           {
               ...
               AXIS2_PARAM_CHECK(env->error, _UserNotRegisteredException1, AXIS2_TRUE);
               
               return !_UserNotRegisteredException1->is_valid_UserNotRegisteredException;
           }
           ...
           adb_UserNotRegisteredException1_set_UserNotRegisteredException_nil(
                   ...
                   const axutil_env_t *env)
           {
               return adb_UserNotRegisteredException1_reset_UserNotRegisteredException(_UserNotRegisteredException1, env);
           }
